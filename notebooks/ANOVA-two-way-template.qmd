...
* In the Project/scripts folder:
  ...
  * `ANOVA_two_way_template.qmd` (this script. Work through it and fill in the code chunks as you go)
...
We want to force R to recognise the categorical variables as factors, and to order their levels as we wish.
...
* line four (sup2worst) tells us that there is a significant drop in weight gain of ...... kg when supplement is changed to worst, regardless of diet.
