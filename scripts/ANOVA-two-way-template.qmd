...
#Enter code to load the packages tidyverse, here, cowplot, gfortify and kableExtra. If need be for any of them, install them first using install.packages("<name of package>") in the console window, not in this script.
